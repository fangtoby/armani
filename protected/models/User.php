...
class User extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('token, expire_time, phone, createTime, updateTime', 'required'),
			array('can_login, login_times', 'numerical', 'integerOnly'=>true),
			array('phone', 'length', 'max'=>100),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, token, expire_time, phone, createTime, updateTime, can_login, login_times', 'safe', 'on'=>'search'),
		);
	}
